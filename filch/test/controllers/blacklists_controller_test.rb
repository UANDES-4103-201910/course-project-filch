...
class BlacklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blacklist" do
    assert_difference('Blacklist.count') do
      post blacklists_url, params: { blacklist: { flagged: @blacklist.flagged, user_id: @blacklist.user_id } }
    end
  ...
  test "should update blacklist" do
    patch blacklist_url(@blacklist), params: { blacklist: { flagged: @blacklist.flagged, user_id: @blacklist.user_id } }
